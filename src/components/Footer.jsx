...
function Footer() {
  return (
    <div className="w-full flex gap-5 h-screen bg-zinc-800 text-white p-20 font-['src\FoundersGrotesk-Semibold.ttf']">
      <div className="w-1/2 flex flex-col justify-between h-full ">
        <div className="heading">
          <h1 className="text-[8vw] uppercase leading-none -mb-8 font-semibold">
            Eye-
          </h1>
          <h1 className="text-[8vw] uppercase leading-none -mb-8 font-semibold">
            Opening
      ...
      <div className="w-1/2">
        <h1 className="text-[5vw] uppercase leading-none -mb-8 font-semibold">
          Presentations
        </h1>
        <div className="details mt-10 font-['src\NeueMontreal-Regular.ttf']">
